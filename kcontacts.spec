...
Version  : 6.13.0
Release  : 90
URL      : https://download.kde.org/stable/frameworks/6.13/kcontacts-6.13.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.13/kcontacts-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/kcontacts-6.13.0.tar.xz.sig
...
%setup -q -n kcontacts-6.13.0
cd %{_builddir}/kcontacts-6.13.0
pushd ..
cp -a kcontacts-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744656905
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Contacts.so.6.13.0
/V3/usr/lib64/qt6/qml/org/kde/contacts/libkcontactsqml.so
/usr/lib64/libKF6Contacts.so.6
/usr/lib64/libKF6Contacts.so.6.13.0
/usr/lib64/qt6/qml/org/kde/contacts/kcontactsqml.qmltypes
/usr/lib64/qt6/qml/org/kde/contacts/kde-qmlmodule.version
/usr/lib64/qt6/qml/org/kde/contacts/libkcontactsqml.so
/usr/lib64/qt6/qml/org/kde/contacts/qmldir
