...
Version  : 5.110.0
Release  : 64
URL      : https://download.kde.org/stable/frameworks/5.110/kcontacts-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kcontacts-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kcontacts-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kcontacts-5.110.0
cd %{_builddir}/kcontacts-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694457328
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Contacts.so.5.110.0
/usr/lib64/libKF5Contacts.so.5
/usr/lib64/libKF5Contacts.so.5.110.0
