...
Version  : 6.10.0
Release  : 87
URL      : https://download.kde.org/stable/frameworks/6.10/kcontacts-6.10.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.10/kcontacts-6.10.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.10/kcontacts-6.10.0.tar.xz.sig
...
%setup -q -n kcontacts-6.10.0
cd %{_builddir}/kcontacts-6.10.0
pushd ..
cp -a kcontacts-6.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736564505
mkdir -p clr-build
pushd clr-build
