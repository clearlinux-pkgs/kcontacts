...
Version  : 5.99.0
Release  : 51
URL      : https://download.kde.org/stable/frameworks/5.99/kcontacts-5.99.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.99/kcontacts-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kcontacts-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kcontacts-5.99.0
cd %{_builddir}/kcontacts-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665420689
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Contacts.so.5.99.0
